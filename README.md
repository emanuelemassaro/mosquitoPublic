...
On the other side, if we look at the epidemic extinction time, we observe a nonlinear correlation between the traveling rate and the epidemic extiction time that has a peak at 0.3.
